        ...
        <?php if(Route::has('login')): ?>
            ...
            <?php else: ?>
                <?php if(auth()->user()->hasRole('administrator')): ?>
                    <a href="<?php echo e(url('/admin')); ?>">Landlord <?php echo e(__('views.welcome.admin')); ?></a>
                <?php elseif(auth()->user()->hasRole('caretaker')): ?>
                    <a href="<?php echo e(url('/admin')); ?>">Caretaker <?php echo e(__('views.welcome.admin')); ?></a>
                <?php elseif(auth()->user()->hasRole('authenticated')): ?>
                    <a href="<?php echo e(url('/admin')); ?>">Tenant <?php echo e(__('views.welcome.admin')); ?></a>
                <?php endif; ?>
