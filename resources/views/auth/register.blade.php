        ...
        <div class="login_wrapper">
            <div class="animate form">
                <section class="login_content">
                    ...
                    <div>
                    {{ Form::label('role_admin', 'Landlord') }}
                    {{ Form::radio('role', 'administrator', true, array('id'=>'role_admin')) }}

                    {{ Form::label('role_tenant', 'Tenant') }}
                    {{ Form::radio('role', 'authenticated', false, array('id'=>'role_tenant')) }}
                    </div>
                    <div>
